...
playerstatsfilename <- paste0("data/ncaa_volleyball_playerstats_", season, ".csv")
matchstatsfilename <- paste0("data/ncaa_volleyball_matchstats_", season, ".csv")
...
playerstatstibble <- playerstatstibble %>% remove_empty(which=c("rows", "cols"))
matchstatstibble <- matchstatstibble %>% remove_empty(which=c("rows", "cols"))
