...
stats.ncaa.org makes team match stats and player season stats easily accessible, but it also exposes each players career and season match stats as well. This scraper is separated from the team and player season stats scraper because it take *significantly* longer to run. Scraping each teams match stats and player season stats takes just shy of 1 hour. This script takes closer to 5 hours to run. 
...
urls <- c("http://stats.ncaa.org/teams/523117", "http://stats.ncaa.org/teams/522809")
